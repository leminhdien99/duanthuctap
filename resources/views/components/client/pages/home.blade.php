            ...
            <div class="title">
                ...
                <ul class="list-inline nav nav-tabs links">
                    <li class="list-inline-item nav-item">
                        <a class="nav-link" href="shop-grid-right.html">Cake & Milk</a></li>
                    <li class="list-inline-item nav-item">
                        <a class="nav-link" href="shop-grid-right.html">Coffes & Teas</a></li>
                    <li class="list-inline-item nav-item">
                        <a class="nav-link active" href="shop-grid-right.html">Pet Foods</a></li>
                    <li class="list-inline-item nav-item">
                        <a class="nav-link" href="shop-grid-right.html">Vegetables</a></li>
                </ul>
            </div>
                ...
                <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                    ...
                    <div class="banner-text">
                        <h4>
                            ...
                            Products </h4>
                        <a href="shop-grid-right.html" class="btn btn-xs">Shop Now
