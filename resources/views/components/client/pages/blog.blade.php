<div class="loop-grid loop-big">
    <div class="row">
        ...
        <article class="first-post mb-30 hover-up animated" style="visibility: visible">
            ...
            <div class="entry-content">
                ...
                <p class="post-exerpt font-medium text-muted mb-30">bánh sô cô la là một món tráng miệng cực kỳ phong phú và ngon miệng,
                    ...
                    mịn làm cho món ăn này trở nên thực sự độc đáo. Nó ngon đến mức gia đình bạn sẽ yêu cầu nó cho mọi dịp đặc biệt!</p>
        ...
        <article class="first-post mb-30 hover-up animated" style="visibility: visible">
            ...
            <div class="entry-content">
                <h2 class="post-title mb-20">
                    <a href="{{route('blogdetail')}}">TCách làm chè gừng gạo nếp ấm nồng cho ngày mưa</a>
                </h2>
                <p class="post-exerpt font-medium text-muted mb-30">Gừng là một thứ gia vị rẻ tiền nhưng hiệu quả cho sức khỏe sẽ khiến
                    ...
                    nóng thì còn gì tuyệt vời hơn, mọi giá lạnh sẽ tan biến. Đặc biệt với những người bị huyết áp thấp thì nên thường xuyên
                    ăn món chè này rất tốt cho sức khỏe.</p>
                <div class="mb-20 entry-meta meta-2">
                    <div class="entry-meta meta-1 mb-30">
                        <div class="font-sm">
                            <span><span class="mr-10 text-muted"><i class="fi-rs-eye"></i></span>23k</span>
        ...
        <article class="first-post mb-30 hover-up animated" style="visibility: visible">
            ...
            <div class="entry-content">
                ...
                <p class="post-exerpt font-medium text-muted mb-30">Bạn sẽ YÊU THƯƠNG với Bát Cơm Gừng Nếp này! Đó là một tình huống nước
                    ...
                    kể cho bạn nghe về một thứ mà tôi vốn YÊU THƯƠNG rất thích ăn. Đó là một tô xôi gừng với cơm trắng nóng hổi, thịt viên
                    dẻo ngọt với chút xíu đá, rau củ ngâm chua chua giòn giòn và xoài chín mọng nước. Xin chào hương vị, màu sắc và kết cấu.
                    Xin chào, hạnh phúc, cảm thấy tốt, đầy trong bụng của tôi.</p>
                <div class="mb-20 entry-meta meta-2">
                    <div class="entry-meta meta-1 mb-30">
                        <div class="font-sm">
                            <span><span class="mr-10 text-muted"><i class="fi-rs-eye"></i></span>23k</span>
